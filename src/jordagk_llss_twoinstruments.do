...
*** January 17, 2019
*** The change-poin is 11.79% not 6.5%
...
local state fstate;  /* slack or zlb or recession */
...
outsheet h multlin1 seylin multexp1 seyexp multrec1 seyrec ptestdiff arp using junkmultse.csv if h<=20, comma replace ;
